...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  apiRouter.post("/api/premium-chat", async (req: Request, res: Response) => {
    try {
      ...
      const response = await generatePremiumResponse(message, conversationHistory);
...
async function generatePremiumResponse(message: string, conversationHistory: any[]) {
